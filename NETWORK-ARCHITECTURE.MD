...
7. **stream.extrachill.com** (Blog ID 9) - Live streaming platform (Phase 1 UI)
8. **newsletter.extrachill.com** (Blog ID 8) - Newsletter operations and Sendy integration hub
